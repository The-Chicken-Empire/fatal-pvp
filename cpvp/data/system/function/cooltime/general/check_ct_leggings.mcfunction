#> system:cooltime/general/check_ct_leggings
#
# オフハンドアイテム使用時に使う
# CTを確認する
#
...
data modify storage cpvp:system tmp.checkct set from entity @s equipment.legs.components.minecraft:custom_data

#> system:cooltime/general/check_ct_offhand
#
# オフハンドアイテム使用時に使う
# CTを確認する
#
...
data modify storage cpvp:system tmp.checkct set from entity @s equipment.offhand.components.minecraft:custom_data

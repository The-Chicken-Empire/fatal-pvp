...
$execute unless items entity @a[tag=meleeatkertmp,limit=1] weapon.mainhand *[custom_data~{cpvp:{custommeleelog:1b}}] run return run data modify storage cpvp:attackdata $(player) set value {id:0b,item_type:"weapon",attacktype:"melee"}

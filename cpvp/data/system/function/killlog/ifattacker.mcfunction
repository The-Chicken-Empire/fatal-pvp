...
execute if score $tmp random matches 3 run tellraw @a [{italic:false,selector:"@s"},{color:"white",italic:false,text:"を最後に殴ったのは"},{italic:false,selector:"@a[tag=tmpkiller,limit=1]"},{color:"white",italic:false,text:"だったのでこの人のキルです！"}]

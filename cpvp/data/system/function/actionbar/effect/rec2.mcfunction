...
execute if score #effect-counter8787 counter2 matches 1000.. run data modify storage effect: actionbar append value [{"text":"\uB018","font":"space"},{"text":"999","font":"effect/level"}]
...
execute store result storage effect: tntn int 1 run scoreboard players get #effect-counter8787 counter2
execute if score #effect-counter8787 counter2 matches 100..999 run function system:actionbar/effect/100_999__ with storage effect:

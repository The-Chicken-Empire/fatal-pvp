...
#@a->@e
execute as @e[type=#main:entity_require_id] if score @s stats_modifier.minexpiration matches -2147483648..2147483647 run function system:stats_modifier/check_expiration
...
execute unless score $stats_modifier.frag main matches 1 if score $tmp1 main matches 0.. unless score @s stats_modifier.minexpiration matches -2147483648..2147483647 run scoreboard players operation @s stats_modifier.minexpiration = $tmp1 main

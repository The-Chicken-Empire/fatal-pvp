#> items:generate/perk/16/generate
#
# アイテム名 : 死に損ないの意地
...
item modify block 0 0 0 container.0 items:generate/perk/16/item

item modify block 0 0 0 container.0 items:generate/perk/16/name

item modify block 0 0 0 container.0 items:generate/perk/16/custom_data
...
item modify block 0 0 0 container.0 items:generate/perk/16/parts

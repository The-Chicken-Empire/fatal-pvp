#> items:generate/perk/36/generate
#
# アイテム名 : 被害妄想
...
item modify block 0 0 0 container.0 items:generate/perk/36/item

item modify block 0 0 0 container.0 items:generate/perk/36/name
...
item modify block 0 0 0 container.0 items:generate/perk/36/ability

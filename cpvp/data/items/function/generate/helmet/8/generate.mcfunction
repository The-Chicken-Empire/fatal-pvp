...
item modify block 0 0 0 container.0 items:generate/helmet/8/item

item modify block 0 0 0 container.0 items:generate/helmet/8/name

item modify block 0 0 0 container.0 items:generate/helmet/8/custom_data

item modify block 0 0 0 container.0 items:generate/helmet/8/cost

item modify block 0 0 0 container.0 items:generate/helmet/8/stats

#abilityがある時はここにコメントを外してファイルをいじる(消して作ったほうが早いかも。その場合は最初の一行を空ける。)
#item modify block 0 0 0 container.0 items:generate/helmet/8/ability

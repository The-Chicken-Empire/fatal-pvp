...
execute at @s if score @s counter4 matches ..-1 positioned ~-1 ~-1 ~-1 as @e[tag=playing,dx=1,dy=1,dz=1] unless score @s teamscore = @a[tag=cp.owner,limit=1] teamscore at @s run function items:skills/weapon/9/skill2/hit

...
execute if score $tmp tmp matches 240.. run return run function items:skills/weapon/5/afterclean
execute facing ^0.04 ^ ^1 positioned ~ ~0.02 ~ run function items:skills/weapon/5/particles
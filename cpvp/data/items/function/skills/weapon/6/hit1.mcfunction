tag @s remove weapon6victim

tag @s add meleedamage
tag @s add physicaldamage
scoreboard players operation @s attackerdata = @e[tag=weapon6tmp4,limit=1] owner

execute store result score $tmp random run random value 3..7

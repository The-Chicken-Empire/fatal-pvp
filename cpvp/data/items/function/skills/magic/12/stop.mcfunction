...
execute at @s positioned ~-0.4 ~-2 ~-0.4 as @e[dx=1,dy=2.5,dz=1,tag=playing] positioned ~-0.2 ~ ~-0.2 if entity @s[dx=1,dy=2.5,dz=1] run function items:skills/magic/12/check

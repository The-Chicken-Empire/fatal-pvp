...
execute at @s positioned ~-0.1 ~-0.1 ~-0.1 as @e[tag=playing,dx=1,dy=1,dz=1] positioned ~-0.8 ~-0.8 ~-0.8 if entity @s[dx=1,dy=1,dz=1] unless score @s teamscore = @e[tag=cp.tmp,limit=1] ownerteam run return run function items:skills/magic/17/skill1/bullet/hit

...
execute if score @s counter matches 10.. if entity @e[tag=playing,tag=cp.what,distance=..3,limit=1] at @s run function items:skills/magic/17/skill1/mine/explode

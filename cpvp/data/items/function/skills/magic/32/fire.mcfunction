...
execute at @s positioned ~-1.5 ~-1 ~-1.5 as @e[tag=playing,dx=3,dy=4,dz=3] unless score @s teamscore = @a[tag=magic32tmp,limit=1] teamscore run function items:skills/magic/32/hit

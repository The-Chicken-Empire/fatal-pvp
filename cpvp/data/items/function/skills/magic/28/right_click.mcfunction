...
execute if entity @e[tag=cp.this,limit=1,scores={counter=0,counter2=20..}] as @e[tag=cp.this,scores={counter=0,counter2=20..}] at @s run function items:skills/magic/28/skill2/up/go

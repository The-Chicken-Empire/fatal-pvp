...
tellraw @s {text:"----------------------------------------"}
execute as @a[distance=..25,tag=!magic3,scores={absorption=..0}] run function items:skills/magic/3/players
execute as @a[distance=..25,tag=!magic3,scores={absorption=1..}] run function items:skills/magic/3/players2

...
execute anchored eyes as @e[tag=magic1,sort=nearest,limit=1] run tp @s ^ ^ ^ ~ ~
scoreboard players operation @e[tag=magic1,sort=nearest,limit=1] owner = @s playerdata
scoreboard players operation @e[tag=magic1,sort=nearest,limit=1] ownerteam = @s teamscore
execute as @e[tag=magic1,limit=1,sort=nearest] run tag @s add tagged
tag @s add owner
#投擲方向指定
...
execute store result entity @e[tag=magic1,sort=nearest,limit=1] Motion[0] double -0.0015 run scoreboard players get @e[tag=tmp,sort=nearest,limit=1] X
execute store result entity @e[tag=magic1,sort=nearest,limit=1] Motion[1] double -0.0015 run scoreboard players get @e[tag=tmp,sort=nearest,limit=1] Y
execute store result entity @e[tag=magic1,sort=nearest,limit=1] Motion[2] double -0.0015 run scoreboard players get @e[tag=tmp,sort=nearest,limit=1] Z
#dummy削除
kill @e[tag=tmp]
#投擲音

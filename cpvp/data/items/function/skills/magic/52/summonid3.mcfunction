...
tag @s add magic52id3
tag @s add magic52id
tag @s add skillmarker
#item
data modify entity @s item set value {id:"minecraft:cobblestone"}
data modify entity @s interpolation_duration set value 3
data modify entity @s transformation set value {right_rotation:[0f,0f,0f,1f],scale:[1f,2f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,-6f,0f]}
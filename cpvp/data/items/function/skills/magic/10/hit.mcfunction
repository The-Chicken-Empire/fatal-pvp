...
execute as @a if score @s playerdata = @e[tag=magic10tmp,limit=1] owner run scoreboard players operation $tmp3 tmp *= @s mr
scoreboard players operation $tmp3 tmp /= $100 main
execute as @a if score @s playerdata = @e[tag=magic10tmp,limit=1] owner run scoreboard players operation @s mp += $tmp3 tmp
execute as @a if score @s playerdata = @e[tag=magic10tmp,limit=1] owner if score @s mp > @s maxmp run scoreboard players operation @s mp = @s maxmp

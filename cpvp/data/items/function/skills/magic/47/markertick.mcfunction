...
execute if score @s skills matches 12.. at @n[tag=m47caster.tmp] positioned ~-0.7 ~-0.2 ~-0.7 as @e[tag=!m47caster,tag=playing,dx=0.4,dy=1.2,dz=0.4] unless score @s teamscore = @n[tag=m47caster.tmp] teamscore run function items:skills/magic/47/hit

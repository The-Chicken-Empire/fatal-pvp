...
execute as @e[tag=magic6,type=marker,tag=skillmarker,limit=1] at @s positioned ~0 ~0 ~0 as @e[tag=!skillmarker,dx=0] unless score @s teamscore = @e[tag=skillmarker,tag=magic6,limit=1] ownerteam positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] run tag @s add magic6victim

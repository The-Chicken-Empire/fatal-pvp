...
tp 0-0-0-0-0 ~ ~ ~ 0 0
execute store result entity 0-0-0-0-0 Rotation[0] float 12 run scoreboard players get @s magic37
execute at @s run function items:skills/magic/37/particle/aura/4/4_blo

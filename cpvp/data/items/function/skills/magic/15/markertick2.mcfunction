...
execute if score @s skills matches 20 at @s positioned ~-1.5 ~-1.5 ~-1.5 as @e[tag=playing,dx=2,dy=2,dz=2] unless score @s teamscore = @e[tag=magic15tmp5,limit=1] teamscore run function items:skills/magic/15/hit

...
execute if score @s skills matches 6 run data modify entity @s transformation set value {right_rotation:[0f,0f,0f,1f],scale:[2f,3f,2f],left_rotation:[0f,0f,0f,1f],translation:[0f,-1.5f,0f]}

...
execute as @a[tag=playing,tag=!magic46tmp] if score @s teamscore = @a[tag=magic46tmp,limit=1] teamscore run function items:skills/magic/46/getminhp
...
execute at @s run particle dust{color:[1,1,1],scale:2} ~ ~ ~ 0.5 1 0.5 0 100 normal

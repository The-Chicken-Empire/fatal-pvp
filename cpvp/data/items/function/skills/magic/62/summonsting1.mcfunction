tag @s add magic62sting1
tag @s add skillmarker

data modify entity @s item set value {components:{"minecraft:custom_model_data":{strings:["magic62sting"]}},id:"minecraft:barrier"}
data modify entity @s interpolation_duration set value 20
data modify entity @s transformation set value {right_rotation:{axis:[1f,0f,0f],angle:1.5708f},scale:[3f,3f,3f],left_rotation:[0f,0f,0f,1f],translation:[0f,1.5f,1.53f]}

...
execute at @s summon marker run function items:skills/magic/29/markersummoned2
execute at @s summon marker run function items:skills/magic/29/markersummoned3

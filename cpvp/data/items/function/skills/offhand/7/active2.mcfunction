...
execute as @e[distance=..10,tag=playing] positioned ~-10 ~-2 ~-10 if entity @s[dx=19,dy=3,dz=19] unless score @s teamscore = @e[tag=offhand7tmp5,limit=1] teamscore run function items:skills/offhand/7/hit2
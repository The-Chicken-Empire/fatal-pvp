execute at @s run playsound block.trial_spawner.ominous_activate player @a ~ ~ ~ 1 0 1
execute at @s run playsound item.mace.smash_ground_heavy player @a ~ ~ ~ 1 0.5 1

...
tag @s add seraph_feather_r
#nbt
data modify entity @s item set value {components:{"minecraft:custom_model_data":{strings:["seraph_feather_r"]},enchantment_glint_override:false},id:"minecraft:golden_hoe",count:1}

...
execute if entity @s[predicate=items:helmet/4/sprint] as @e[tag=seraph_wing,tag=!seraph_wing.sprinting,tag=cp.this] run function items:skills/helmet/4/wings/tick2
execute if entity @s[predicate=items:helmet/4/sprint] as @e[tag=seraph_wing,tag=seraph_wing.sprinting,tag=cp.this] run function items:skills/helmet/4/wings/tick4
execute if entity @s[predicate=!items:helmet/4/sprint] as @e[tag=seraph_wing,tag=cp.this] run function items:skills/helmet/4/wings/tick3

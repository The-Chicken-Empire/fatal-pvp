...
execute as @a[tag=victim] if score @s damagetaken matches 100.. if items entity @s hotbar.* *[minecraft:custom_data~{cpvp:{id:29b,item_type:"perk"}}] run function items:skills/perk/29/check

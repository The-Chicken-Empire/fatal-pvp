...
data modify storage effect: data.id set value 51
#idです。他の人と被らないようにしろ。※>>>必須<<<
data modify storage effect: data.maxlevel set value 9999
#バフの最大レベルです。初期値1
data modify storage effect: data.content set value [["maxhp",-100,0]]

...
data modify storage effect: data.id set value 31
#idです。他の人と被らないようにしろ。※>>>必須<<<
data modify storage effect: data.maxlevel set value 2
#バフの最大レベルです。初期値1
data modify storage effect: data.content set value [["vit",-25,0]]

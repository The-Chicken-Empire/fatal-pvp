...
data modify storage effect: data.id set value 55
#idです。他の人と被らないようにしろ。※>>>必須<<<
data modify storage effect: data.maxlevel set value 1
#バフの最大レベルです。初期値1
data modify storage effect: data.content set value [["speed",0,150]]
...
#attribute?
attribute @s safe_fall_distance modifier add effect55 9999 add_value
attribute @s step_height modifier add effect55 2 add_value
attribute @s gravity modifier add effect55 0.5 add_value
...
execute if score $tmp tmp matches 200.. run function effects:effects/46/explode

execute if entity @s[tag=effect46explode] run return run tag @s remove effect46explode

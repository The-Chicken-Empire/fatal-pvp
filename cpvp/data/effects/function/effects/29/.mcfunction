...
data modify storage effect: data.id set value 29
#idです。他の人と被らないようにしろ。※>>>必須<<<
data modify storage effect: data.maxlevel set value 1
#バフの最大レベルです。初期値1
data modify storage effect: data.content set value [["speed",0,-300],["damage",0,-100],["defence",0,100]]
...
data modify storage effect: data.invisible set value 1b

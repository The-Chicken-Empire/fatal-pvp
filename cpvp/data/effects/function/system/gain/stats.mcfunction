...
execute store result score #effect-counter4113 counter3 run data get storage effect: data.content[0][2] 1
scoreboard players operation #effect-counter4113 counter += #effect-counter4113 counter3

...
$execute if entity @s[type=player] run data remove storage effect: player[{id:$(UUID)}].effects
$execute if entity @s[type=!player] run data remove storage effect: entity[{id:$(UUID)}].effects
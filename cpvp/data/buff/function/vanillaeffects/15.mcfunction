...
data modify storage buff: gain.functionwhenexpired set value "cpvp:buff/vanillaeffects/15end"
data modify storage buff: gain.functiontick set value "cpvp:buff/vanillaeffects/15tick"

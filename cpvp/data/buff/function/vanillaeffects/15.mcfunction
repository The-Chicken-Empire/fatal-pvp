...
data modify storage buff: gain.functionwhenexpired set value "buff:vanillaeffects/15end"
data modify storage buff: gain.functiontick set value "buff:vanillaeffects/15tick"

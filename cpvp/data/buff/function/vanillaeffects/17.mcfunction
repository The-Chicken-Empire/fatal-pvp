...
data modify storage buff: gain.functiontick set value "buff:vanillaeffects/17tick"
data modify storage buff: gain.functionwhenexpired set value "buff:vanillaeffects/17end"

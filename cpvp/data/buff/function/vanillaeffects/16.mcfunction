...
data modify storage buff: gain.functiontick set value "buff:vanillaeffects/16tick"
data modify storage buff: gain.functionwhenexpired set value "buff:vanillaeffects/16end"

...
data modify storage buff: gain.maxlevel set value 111
#バフの最大レベルです。初期値1
data modify storage buff: gain.duration set value 10000
#効果時間です 1秒は20です。-1なら永続です。初期値-1
data modify storage buff: gain.buffcontent set value [["maxhp",10,10],["speed",2000,2000]]
...
#バフ終了時、tick時のファンクションでは、buff: check.customdataに格納されています。初期値なし

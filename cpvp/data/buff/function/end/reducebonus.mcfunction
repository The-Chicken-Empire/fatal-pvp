...
execute store result score #buff-counter1224 counter2 run data get storage buff: check.level
...
execute if data storage buff: content[0] run function buff:end/reducebonus with storage buff: aeae

...
execute if data storage buff: {check:{isbuff:0b}} run function buff:modify/ with storage buff: check
...
execute if data storage buff: temp[0] run function buff:modify/debuff2
